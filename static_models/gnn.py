...
from static_models.transforms import BatchNodeFeatureTransform, BatchEdgeListTransform
...
class LightningGNN(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        self.log("val_bacc", self.val_bacc.compute(), prog_bar=False)
